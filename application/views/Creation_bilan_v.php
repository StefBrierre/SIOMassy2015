...
// Valeur du champ id depuis $_POST (fonction form_helper)
$date = set_value("datebilan");
// Erreur associée au champ id
$dateError = form_error("datebilan");
    ...
    <body>
        <section>
            ...
            <form id="liste_session" method="POST">
                ...
                <input type="text" name="datebilan" placeholder="Date du bilan" data-beatpicker="true" data-beatpicker-position="['10','50']"  
